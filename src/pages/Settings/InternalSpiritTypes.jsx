...
function InternalSpiritTypes() {
  ...
  const currentItems = spiritTypes.slice(startIndex, endIndex)
                  ...
                  <tr key={item.id} className="hover:bg-primary-dark/50 transition-colors duration-200">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-gray-500">|</span>
                        <button
                          onClick={() => handleBotanicals(item.id)}
                          className="text-accent-gold hover:text-accent-gold-light transition-colors duration-200 font-medium"
                        >
                          Botanicals
                        </button>
                    ...
                    <td className="px-6 py-4">
                      <div className="text-gray-300">{item.productionPart4 || '—'}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-gray-300">{item.processingPart3 || '—'}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-gray-300">{item.processingPart4 || '—'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-gray-300">{item.wineProcessingBulk ? 'true' : 'false'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-gray-300">{item.imported ? 'true' : 'false'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-gray-300">{item.bottledImported ? 'true' : 'false'}</div>
                    </td>
                  </tr>
                ))
              )}
